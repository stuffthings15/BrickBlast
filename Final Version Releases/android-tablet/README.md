...
1. Transfer `BrickBlast-release.apk` to your Android tablet (USB, email, or Drive)
2. Open the file on your tablet
3. If prompted, enable **"Install unknown apps"** for your file manager in Settings
4. Launch **Brick Blast** from the app drawer — game auto-scales to tablet screen
...
connection is needed after install. The canvas auto-scales to fill the tablet viewport.
...
## Requirements
- Android 7.0+ (API 24)
- Any tablet 7" or larger — landscape orientation recommended
